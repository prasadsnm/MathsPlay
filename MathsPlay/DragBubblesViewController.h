...
{
    UILabel *instructionLabel, *greetingsLabel, *messageLabel, *numberLabel1,*numberLabel2,*numberLabel3,*numberLabel4,*numberLabel5,*numberLabel6, *journeyLabel;
    NSMutableDictionary *dic;
    UIImageView *avatarImage,*orangeImage1,*orangeImage2,*orangeImage3,*orangeImage4,*orangeImage5,*orangeImage6;
    int  randomnumber,value2,value3,value4,value5,value6,number1hide,number2hide,number3hide,optionframe1value,optionframe2value,optionframe3value,optionframe4value,optionframe5value,optionframe6value;
